...
export default function FAQBodega() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí, 100%. Puedes controlar tu bodega desde tu celular Android o iPhone. Vendes, ves reportes y cierras caja desde donde estés."
    },
    {
    ...
    },
    {
      ...
      a: "Sí, puedes importar todos tus productos desde un Excel. Te damos la plantilla y te ayudamos a subirlos. En minutos tienes todo listo."
    },
    {
            ...
            <ScrollReveal key={i} delay={i * 50}>
              <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 transition-all">
                ...
                >
                  ...
                  <svg
                    className={`w-5 h-5 text-blue-600 flex-shrink-0 transition-transform ${openIndex === i ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
